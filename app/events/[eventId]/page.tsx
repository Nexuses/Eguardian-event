      ...
      <div className="mx-auto grid max-w-6xl grid-cols-1 gap-6 px-4 pb-8 sm:gap-8 sm:pb-12 lg:grid-cols-3">
        ...
        <div className="lg:col-span-2">
          ...
          <div className="mt-6 rounded-xl border border-zinc-200 bg-white p-4 dark:border-zinc-800 dark:bg-zinc-900 sm:mt-8 sm:p-6">
            <h2 className="mb-3 text-sm font-semibold uppercase tracking-wider text-zinc-500 dark:text-zinc-400 sm:mb-4">
              Share this event
            </h2>
          ...
          <div className="sticky top-4 space-y-4 sm:top-6 sm:space-y-6">
            ...
            <div className="rounded-xl border border-zinc-200 bg-white p-4 dark:border-zinc-800 dark:bg-zinc-900 sm:p-6">
              ...
              <dl className="space-y-4 text-sm">
                ...
                {event.venue ? (
                  <div>
                    <dt className="mb-0.5 font-medium uppercase tracking-wider text-zinc-500 dark:text-zinc-400">Venue</dt>
                    <dd className="text-zinc-900 dark:text-zinc-100">{event.venue}</dd>
                  </div>
                ) : null}
                <div>
                  <dt className="mb-0.5 font-medium uppercase tracking-wider text-zinc-500 dark:text-zinc-400">Speakers</dt>
                  <dd className="text-zinc-900 dark:text-zinc-100">{event.speaker || "—"}</dd>
                </div>
                <div>
                  <dt className="mb-0.5 font-medium uppercase tracking-wider text-zinc-500 dark:text-zinc-400">Phone</dt>
                  <dd className="text-zinc-900 dark:text-zinc-100">{event.phone || "—"}</dd>
                </div>
              </dl>
            </div>
          </div>
