    ...
    <div className="min-h-full bg-white">
      ...
      <div className="mx-auto grid max-w-6xl grid-cols-1 gap-6 px-4 py-4 sm:gap-8 sm:py-6 lg:grid-cols-3">
        ...
        <div className="lg:col-span-2">
          ...
          {showDescription ? (
            <div className="mt-6 rounded-xl border border-zinc-200 bg-white p-4 sm:mt-8 sm:p-6">
          ...
          <div className="mt-6 rounded-xl border border-zinc-200 bg-white p-4 sm:mt-8 sm:p-6">
            ...
            <div className="flex flex-wrap gap-2 sm:gap-3">
              <a
                ...
                className="flex h-10 w-10 items-center justify-center rounded-full bg-zinc-100 text-zinc-600 transition-colors hover:bg-orange-100 hover:text-orange-500"
