  ...
  return (
    <div className="rounded-md border border-zinc-300">
      ...
      <div
        ...
        className={`${inputClass} ${gapStyles} overflow-y-auto rounded-t-none empty:before:pointer-events-none empty:before:text-zinc-500 empty:before:content-[attr(data-placeholder)] [&_b]:font-bold [&_hr]:my-4 [&_hr]:border-0 [&_hr]:border-t [&_hr]:border-zinc-300 [&_strong]:font-bold`}
      />
    </div>
  );
}
